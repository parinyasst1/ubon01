...
//                                                                                                                                                                                                                                log.info("solartotaloutputaccall : {}", solartotaloutputaccall[0]);
                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                userUpdates.put("gridkwTall", gridkwTall[0].floatValue());
                                                                                                                                                                                                                                userUpdates.put("LoadkwTall", LoadkwTall[0].floatValue());

                                                                                                                                                                                                                                userUpdates.put("solartotalinputall", solartotalinputall[0].floatValue());
                                                                                                                                                                                                                                userUpdates.put("solartotaloutputall", solartotaloutputall[0].floatValue());
                                                                                                                                                                                                                                userUpdates.put("persengridall", persengridall[0].floatValue());
                                                                                                                                                                                                                                userUpdates.put("persenpvall", persenpvall[0].floatValue());
                                                                                                                                                                                                                                userUpdates.put("persensolarall", persensolarall[0].floatValue());

                                                                                                                                                                                                                                userUpdates.put("griduseall", griduseall[0].floatValue());
                                                                                                                                                                                                                                userUpdates.put("loadall", loadall[0].floatValue());
                                                                                                                                                                                                                                userUpdates.put("solartotalinputaccall", solartotalinputaccall[0].floatValue());
                                                                                                                                                                                                                                userUpdates.put("solartotaloutputaccall", solartotaloutputaccall[0].floatValue());
